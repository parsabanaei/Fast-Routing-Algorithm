...
void showFoods(Ui::FoodPurchase* ui);
//GlobalData globalData;


FoodPurchase::FoodPurchase(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::FoodPurchase)
{
    ui->setupUi(this);
...
void showFoods(Ui::FoodPurchase* ui)
{
   ...
   // QTableWidgetItem *item = new QTableWidgetItem;
    ...
    if(dbHandler.open())
    {
        QSqlQuery query1("SELECT ID, City, Food, Price FROM Foods WHERE IsActive=1 AND IsFoodActive=1");
...
void FoodPurchase::on_pushButton_2_clicked()
{
    QMessageBox msgBox;
   // QSqlQuery qry;
     //QSqlQuery query;
